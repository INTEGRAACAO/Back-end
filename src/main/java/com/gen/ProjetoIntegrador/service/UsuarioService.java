package com.gen.ProjetoIntegrador.service;
...
public class UsuarioService {
	...
	public Optional<Usuario> atualizarUsuario(Usuario usuario) {
		...
		if (usuarioRepository.findById(usuario.getId()).isPresent()) {
			...
			Optional<Usuario> buscaUsuario = usuarioRepository.findByApelido(usuario.getApelido());
	...
	public Optional<UsuarioLogin> autenticarUsuario(Optional<UsuarioLogin> usuarioLogin) {
		...
		Optional<Usuario> usuario = usuarioRepository.findByApelido(usuarioLogin.get().getApelido());
